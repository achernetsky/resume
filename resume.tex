...
\cventry{Septermber 2015 - October 2018}{Full stack web developer of clan portal}{}{}{}{Support of legacy code of \href{http://wargaming.net/clans}{Clan portal}, bug-fixing and implementation of new features.}
\cvline{tools}{\emph{Linux, Python (Django, Wagtail), RabbitMQ, Javascript (Backbone, Webpack, Jasmine, Sinon, Karmajs), PostgreSQL, git.}}

\cventry{}{Full stack web developer of client in game browser solutions}{}{}{}{Development single page applications for World of Tanks and World of Warships client browser (cef). I have developed the following key parts of system:
\begin{itemize}
