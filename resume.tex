...
\cventry{2016 - 2018}{Go developer}{}{}{}{Development a versatile agent which collect logs and forward them to cloud. Logs sources were:
\begin{itemize}
  \item rfc3164, rfc5424 by udp and tcp;
  \item tail any file;
  \item cron job output;
\end{itemize}
The following techniques and tricks were used: \href{https://github.com/omniti-labs/jlog}{JLog}, \href{https://en.wikipedia.org/wiki/Exponential_backoff}{exponential backoff}, \href{https://en.wikipedia.org/wiki/Circuit_breaker_design_pattern}{circuit breaker design pattern} and gracefully shutdown.}
\cvline{tools}{\emph{Linux, Go, git.}}
...
\begin{itemize}
  ...
  \item communicate effectively with a large numbers of departments, such as QA, Pre-production, Release managers, Localizers, Business analysts;
\end{itemize}}
\cvline{tools}{\emph{Linux, Python (Aiohttp, Django), RabbitMQ, Gunicorn, Javascript (Typescript, React, Webpack, Babel), PostgreSQL, git.}}
...
\cvline{tools}{\emph{Linux, Python (Django, Wagtail), RabbitMQ, Javascript (Backbone, Webpack, Jasmine, Sinon, Karmajs), PostgreSQL, git.}}
...
\cvline{tools}{\emph{Linux, Python (Django), Javascript (jQuery), PostgreSQL, git, memchached.}}
...
\section{Languages}
\cvline{\textbf{Spanish}}{Beginner}
\cvline{\textbf{English}}{Intermediate}
...
\cvcomputer{\textbf{Languages}}{C, Java, Scala, Scheme,\\ Octave, assembly language,\\ ClojureScript, Clojure}{\textbf{Databases}}{MySQL, CouchDB}
