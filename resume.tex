...
\section{Education}
\cventry{2009-2014}{Engineer's degree}{BSUIR}{Minsk}{}{Graduated from \emph{Belarusian State University of Informatics and Radioelectronics} in \emph{2014}. The professional qualification received is \emph{mathematician--software engineer}.}

\section{Diploma project}
\cvline{title}{\emph{Service to provide distributed locks and storage of configurations}}
\cvline{description}{The goal of the diploma project was to develop an application for obtaining distributed locks using the \emph{RAFT} consensus algorithm. I based my work on the paper ``In Search of an Understandable Consensus Algorithm'' by Diego Ongaro and John Ousterhout presented in Stanford University.}

\section{Experience}

\subsection{Gurtsoft (\url{http://gurtam.com}), Minsk (August 2012-Present)}

\cventry{}{Key developer of Gurtam routing service}{}{}{}{Development of service for computing optimal routes in road network. Mainly, namely and so far I develop key parts of system:
\begin{itemize}
...
\end{itemize}}
\cvline{tools}{\emph{C++, Boost, OMP, gcc, GNU make, Berkeley DB, git.}}
