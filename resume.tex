...
\cvline{tools}{\emph{Linux, Python 2 (Django), Javascript, PostgreSQL, Memchached.}}
...
\cvline{tools}{\emph{Objective C, Python 2 (Django), Javascript, PostgreSQL.}}
...
\cventry{}{Developer of \href{http://notsharingmy.info}{notsharingmy.info}}{}{}{}{Web anonymizer which --- among other features -- generates anonymous emails for users so that they do not disclose their ones. Implementation of new features and protection mechanisms, bug-fixing.}
\cvline{tools}{\emph{Linux, Python 2 (Django), MongoDB, jQuery.}}
