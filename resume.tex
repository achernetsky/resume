...
\cventry{Septermber 2016 - Present}{Full stack web developer of clan portal}{}{}{}{Support of legacy code of \href{http://wargaming.net/clans}{Clan portal}, bug-fixing and implementation of new features.}
\cvline{tools}{\emph{Linux, Python (Django, Wagtail), Javascript (Backbone, Webpack, Jasmine, Sinon, Karmajs), PostgreSQL, git.}}

\cventry{}{Full stack web developer of client in game browser solutions}{}{}{}{Development single page applications for World of Tanks and World of Warships client browser (cef). I have developed so far the following key parts of system:
\begin{itemize}
  \item authentication worker based on wargaming interal system;
  \item write SDD for team developers and lead some key features in projects;
\end{itemize}}
\cvline{tools}{\emph{Linux, Python, Gunicorn, Javascript (es6), React, webpack, babel, PostgreSQL, git.}}
...
\cvcomputer{\textbf{Languages}}{C, Java, Scala, Scheme,\\ Octave, assembly language,\\ Golang}{\textbf{Databases}}{MySQL, CouchDB}
